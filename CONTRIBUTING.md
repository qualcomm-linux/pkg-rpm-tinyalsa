# Contributing to pkg-rpm-tinyalsa
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-tinyalsa.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-rpm-tinyalsa/pulls) from your branch to `main`.
